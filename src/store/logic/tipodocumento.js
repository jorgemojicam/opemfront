...
export default {
    ...
    actions: {
        ...
        async getData({
            ...
            try {
                commit("showLoader");
                const response = await axios.get(`/tipodocs`);
        ...
        async newItem({
            ...
            try {
                ...
                const result = await axios.post(`/tipodocs`, payload);
        ...
        async deleteItem({
            ...
            try {
                await axios.delete(`/tipodocs/${state.deleteId}`);
        ...
        async getDataForm({
            ...
            try {
                ...
                const response = await axios.get(`/tipodocs/${payload}`);
        ...
        async editItem({
            ...
            try {
                console.log(payload)
                const result = await axios.put(`/tipodocs/${id}`, payload);
